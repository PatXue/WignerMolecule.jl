...
\usepackage{amsmath}
\usepackage[style=nature, eprint=true, intitle=true, url=false]{biblatex}
...
\newpage
\section{Dimer Model}
The current method of proposing changes to the dimer configuration produces
energy changes that are too large, and so are often rejected. Currently working
on adapting the algorithm in~\cite{PhysRevDirLoop,arXivDirLoop,ClassDirLoop}
